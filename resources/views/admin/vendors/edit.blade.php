                                        ...
                                        <form class="form" action="{{route('admin.vendors.update',['id'=>$vendor->id])}}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label id="projectinput7" class="file center-block">
                                                    <input onchange="previewImage(this);" type="file" id="file" name="logo">
                                                        ...
                                                        <div class="form-group col-12">
                                                            ...
                                                            <select name="academy_id" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر  التصنيف ">
                                                                    @isset($vendor->category)

                                                                            <option
                                                                                value="{{$vendor->category->id}}">  {{$vendor->category->name}}
                                                                            </option>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-5">
                                                                    <input type="text" class="form-control"
                                                                           ...
                                                                           value="{{$vendor->lat}}" id="lat">
                                                                </div>
                                                                <div class="col-5">
                                                                    <input type="text" class="form-control"
                                                                           placeholder="lng" name="lng"
                                                                           value="{{$vendor->lng}}" id="lng">
                                                                </div>
                                                            </div>
