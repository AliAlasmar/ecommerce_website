                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.maincategories.update',['id'=>$mainCategories->id])}}" method="POST"
                                              enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label> صوره القسم </label>
                                                <label id="projectinput7" class="file center-block">
                                                    <input value="{{$mainCategories->photo}}" type="file" id="file" name="photo">
                                                    <span class="file-custom"></span>
                                                </label>
                                                <img width="100px" height="100px" src="{{asset('assets/images/maincategories/'.$mainCategories->photo)}}">
                                                @error('photo')
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> اسم القسم-{{__('messages.'.$mainCategories->translation_lang)}} </label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{$mainCategories->translation_lang}}" id="abbr"
                                                                       class="form-control"
